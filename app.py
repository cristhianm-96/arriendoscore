...
# VARIABLES NUEVAS PARA CORREO
EMAIL_HOST = os.environ.get("EMAIL_HOST", "smtp.gmail.com")
EMAIL_PORT = int(os.environ.get("EMAIL_PORT", 587))
EMAIL_USER = os.environ.get("EMAIL_USER", os.environ.get("GMAIL_USER"))
EMAIL_PASS = os.environ.get("EMAIL_PASS", os.environ.get("GMAIL_PASSWORD"))
...
def enviar_codigo(destinatario, codigo, nombre):
    if not EMAIL_USER or not EMAIL_PASS: 
        print("Error: Faltan variables EMAIL_USER o EMAIL_PASS")
        return
    ...
    try:
        # Ahora usa TLS puerto 587 con las variables nuevas
