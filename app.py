...
def dashboard():
    ...
    alerta = ""
    if request.args.get('msg') == 'reportado': alerta = "<div style='padding:10px; background:#2ecc71; color:white; border-radius:8px; margin-bottom:15px;'>Inquilino reportado. Ya quedó en Base Universal y se envió correo.</div>"
